...
const props = defineProps<{
  activity: {
    ...
    durations: string[]
    information: string
    image?: string | null // Image can be string or null/undefined
  }
  isReversed: boolean
}>()

// Check if there's a valid image, otherwise use the local image
const imageMissing =
  props.activity.image && props.activity.image.trim() !== '' ? props.activity.image : missingImage
</script>
